...
export const mockCases: any[] = [
  ...
  // ── Case #US-8911 (Siddhant — Vantage: Warehouse Stall) ────────────────
  {
    ...
    caseAuditLogs: [
      ...
      { id: 1008, type: 'System', title: 'Warehouse Ticket #WH-882 — Awaiting Reply', time: '11/07, 04:35 PM', details: 'Ticket #WH-882 raised to AUS-01 Shift Lead: "Order #TX-FedEx-8911 has been in pick queue for 24+ hours without a pick scan. Please prioritize and confirm ETA." Status: OPEN. No reply received within first 6-hour window.', isVantage: false },
      { id: 1007, type: 'Warehouse', title: 'Order Routed to Facility', time: '11/06, 04:35 PM', details: 'Order assigned to Austin TX Fulfillment Center. Added to pick queue. Warehouse confirmed receipt of routing assignment.', isVantage: false },
    ...
    caseVantageActions: [
      { id: 1012, type: 'VantageAction', title: 'Human Escalation — WH Unresponsive', time: '11/08, 08:00 AM', details: 'Vantage exhausted all automated follow-up protocols for Ticket #WH-882. Warehouse has not responded in 12 hours. Case escalated to Associate queue for direct phone contact with AUS-01 Dispatch.', isVantage: true, actionCategory: 'alert' },
      { id: 1011, type: 'VantageAction', title: 'Reminder #2 Sent — 6h SLA Checkpoint', time: '11/07, 10:35 PM', details: 'Second automated reminder sent to AUS-01 for Ticket #WH-882: "URGENT: Order still not picked. SLA window is shrinking. Please respond immediately." No reply received.', isVantage: true, actionCategory: 'alert' },
      { id: 1009, type: 'VantageAction', title: 'Ticket #WH-882 Raised — No Response', time: '11/07, 04:35 PM', details: 'Order stalled in pick queue for >24 hours. Vantage raised Ticket #WH-882 to AUS-01 Shift Lead and sent initial notification. Status: OPEN. First 6-hour response window started.', isVantage: true, actionCategory: 'alert' },
